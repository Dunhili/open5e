.. _srd:sorcerer-draconic-archetype:
...
modifier to one damage roll of that spell. The damage bonus applies to
one damage roll of a spell, not multiple rolls. At the same time, you can
